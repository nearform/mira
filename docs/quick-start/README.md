...
2. Install the required dependencies, as instructed by the specific sample you cloned.
    ...
    Make sure you use a supported version of the CDK (__1.60.0__) and all the required dependencies are included in your package.json file.
